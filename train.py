...
flags.DEFINE_string('imagenet_ckpt',
                    '/data/repositories/isaac/apps/carter_sim_struct2depth/struct2depth/resnet_pretrained/model.ckpt',
                    'Initialize the weights according '
                    'to an ImageNet-pretrained checkpoint. Requires '
                    'architecture to be ResNet-18.')
flags.DEFINE_string('checkpoint_dir',
                    '/data/repositories/isaac/apps/carter_sim_struct2depth/struct2depth/ckpts/ckpts_40_delay_hospital',
