...
# ROOT_DIR = os.path.abspath("./struct2depth")
...
flags.DEFINE_string('data_dir', '/usr/local/lib/isaac/apps/carter_sim_mod/struct2depth/kitti_processed_data', 'Preprocessed data.')
...
flags.DEFINE_string('checkpoint_dir', '/usr/local/lib/isaac/apps/carter_sim_mod/struct2depth/ckpts', 'Directory to save model '
                    'checkpoints.')
